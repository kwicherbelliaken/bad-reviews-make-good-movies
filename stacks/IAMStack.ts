...
export function IAMStack({ app, stack }: StackContext) {
  if (app.stage === "production") {
    ...
    const organization = "kwicherbelliaken"; // use your GitHub organization
    const repository = "bad-reviews-make-good-movies"; // use your GitHub repository
